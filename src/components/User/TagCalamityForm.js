...
const TagCalamityForm = ({
  ...
  // derived — keep coords for data, not shown in UI
  ...
  // auto-detect barangay from polygon
  useEffect(() => {
    ...
    try {
      ...
      const closedRing = JSON.stringify(first) === JSON.stringify(last) ? ring : [...ring, first];
        ...
        <div className="bg-white rounded-2xl shadow-sm border border-gray-200 overflow-hidden">
          ...
          <div className="max-h-[92vh] overflow-y-auto [scrollbar-gutter:stable]">
            ...
            <div className="sticky top-0 z-10 px-6 py-5 bg-white/90 backdrop-blur border-b rounded-t-2xl supports-[backdrop-filter]:bg-white/80">
              <h2 className="text-xl font-bold text-gray-900">Report Calamity</h2>
              <p className="text-sm text-gray-500 mt-1">
                Provide clear incident details for accurate mapping and analysis.
              </p>
            </div>

            {/* Body */}
            <form onSubmit={handleSubmit} className="p-6 space-y-7">
              {/* Context chips — barangay + area (coords hidden in UI) */}
              <div className="flex flex-wrap gap-2">
                {(barangay || selectedBarangay) && <Pill color="blue">{barangay || selectedBarangay}</Pill>}
                {defaultLocation?.hectares && (
                  <Pill color="emerald">{Number(defaultLocation.hectares).toFixed(2)} ha (default)</Pill>
                )}
                {/* Debug only:
              ...
              {/* Incident */}
              <Section title="Incident details" subtitle="Basic information about the calamity.">
              ...
              {/* Crop & Ecosystem */}
              <Section title="Crop & ecosystem" subtitle="These fields tailor recommendations and analysis.">
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-5">
                  <div>
                    ...
                    <div className="relative">
                      ...
                      {loadingMeta && <div className="absolute right-3 top-2.5 text-gray-400"><Spinner /></div>}
                    </div>
                  ...
                  <div>
                    ...
                    >
                      <option value="">{!cropTypeId ? "Select crop type first" : "Select ecosystem"}</option>
                  ...
                  {cropTypeId && (
                    <div className="sm:col-span-2">
                      ...
                      <div className="relative">
                        ...
                        >
                          <option value="">{loadingVarieties ? "Loading varieties..." : "Select crop variety"}</option>
                        ...
                        {loadingVarieties && <div className="absolute right-3 top-2.5 text-gray-400"><Spinner /></div>}
                      </div>
              ...
              {/* Area & Evidence */}
              <Section title="Area & evidence" subtitle="Estimate coverage and attach a clear photo if possible.">
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-5">
                  <div>
              ...
              <div className="flex gap-3 pt-4 border-t border-gray-200">
                <button
                  type="button"
                  onClick={onCancel}
                  className="flex-1 px-4 py-2.5 border-2 border-gray-300 rounded-xl text-sm font-medium text-gray-700 bg-white hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-400"
                >
                  Cancel
                </button>
                <button
                  ...
                  className={`flex-1 inline-flex items-center justify-center gap-2 px-4 py-2.5 rounded-xl text-sm font-medium text-white focus:outline-none focus:ring-2 focus:ring-offset-2 ${
